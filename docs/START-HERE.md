...
| Code SSOT | `java-ast-ssot` 1.0 — core + `javaee-ejb2-jboss` + **`jpa`** + crosswalk |
...
| **Next** | `mybatis` profile (ADR-004 Step 5); JPA Duke's Bank E2E re-export (4d) |
