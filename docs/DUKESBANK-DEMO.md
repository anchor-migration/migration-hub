...
| `metadata/symbols.db` | `stubborn` | SCIP symbol graph (Step 7; gitignored) |
| `metadata/account-controller.stub.java` | `stubborn` | LLM context for session facade (Step 7) |
...
**Prerequisites:** Steps 1–6 unchanged; external `dukesbank` clone; `stubborn` on PATH or Docker image.
...
```powershell
cd stubborn\examples\dukesbank
.\scripts\run-e2e.ps1
...
| Output | Path |
|--------|------|
| Symbol graph | `stubborn/examples/dukesbank/metadata/symbols.db` |
| Java stub | `.../metadata/account-controller.stub.java` |
| Stubborn-DSL | `.../metadata/account-controller.stubborn-dsl` |
...
Case: [account-controller-context.md](https://github.com/stubborn-ai/stubborn/blob/main/examples/dukesbank/cases/account-controller-context.md) · [ADR-010](ADR-010-stubborn-integration.md) · [MCP](https://github.com/stubborn-ai/stubborn/blob/main/docs/MCP.md).
...
| [ADR-010](ADR-010-stubborn-integration.md) + [dukesbank example](https://github.com/stubborn-ai/stubborn/tree/main/examples/dukesbank) | Step 7 — LLM context |
...
| Date | Change |
|------|--------|
| 2026-07-01 | **Step 7** — stubborn Duke's Bank LLM context runbook (`dukesbank-e2e`, `run-stubborn-context.ps1`) |
